...
export function loadFrom(lookup: (key: string) => string | undefined): CliEnvValues {
  return {
    ...
    declmig_api_http_base: nonEmpty(lookup("DECLMIG_API_HTTP_BASE")),
    declmig_database_url: nonEmpty(lookup("DECLMIG_DATABASE_URL")),
    declmig_web_bind: nonEmpty(lookup("DECLMIG_WEB_BIND")),
...
export function loadEnvMap(
  ...
  const declmig_api_http_base = pick(["DECLMIG_API_HTTP_BASE"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (declmig_api_http_base !== undefined) out["DECLMIG_API_HTTP_BASE"] = declmig_api_http_base;
  const declmig_database_url = pick(["DECLMIG_DATABASE_URL"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (declmig_database_url !== undefined) out["DECLMIG_DATABASE_URL"] = declmig_database_url;
  const declmig_web_bind = pick(["DECLMIG_WEB_BIND"], ["flags", "env_shell", "env_file"], shell, dotenv, flags, undefined);
  if (declmig_web_bind !== undefined) out["DECLMIG_WEB_BIND"] = declmig_web_bind;
