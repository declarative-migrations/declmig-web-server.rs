//! Four-avenue web ↔ API binding for `declarative-migrations`.
//!
//! 1. Direct read-only DB via `*-lib-core` named queries (no migrations).
//! 2. Stateless HTTP from `app.declarative-migrations.dev` to `api.declarative-migrations.dev`.
//! 3. Stateful TLS 1.3/mTLS TCP to `api.declarative-migrations.dev:7443`.
...
pub const GITHUB_ORG: &str = "declarative-migrations";
pub const ORG_SLUG: &str = "declmig";
pub const DNS_ZONE: &str = "declarative-migrations.dev";
