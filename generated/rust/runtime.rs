...
pub struct CliEnvValues {
    ...
    pub declmig_api_http_base: Option<String>,
    pub declmig_database_url: Option<String>,
    pub declmig_web_bind: Option<String>,
...
pub fn load_from(lookup: impl Fn(&str) -> Option<String>) -> CliEnvValues {
    CliEnvValues {
        ...
        declmig_api_http_base: lookup("DECLMIG_API_HTTP_BASE").filter(|value| !value.is_empty()),
        declmig_database_url: lookup("DECLMIG_DATABASE_URL").filter(|value| !value.is_empty()),
        declmig_web_bind: lookup("DECLMIG_WEB_BIND").filter(|value| !value.is_empty()),
...
pub fn load_env_map(
    ...
    let declmig_api_http_base = pick(&["DECLMIG_API_HTTP_BASE"], &["flags", "env_shell", "env_file"], shell, dotenv, flags, None);
    if let Some(value) = declmig_api_http_base {
        out.insert("DECLMIG_API_HTTP_BASE".to_string(), value);
    }
    let declmig_database_url = pick(&["DECLMIG_DATABASE_URL"], &["flags", "env_shell", "env_file"], shell, dotenv, flags, None);
    if let Some(value) = declmig_database_url {
        out.insert("DECLMIG_DATABASE_URL".to_string(), value);
    }
    let declmig_web_bind = pick(&["DECLMIG_WEB_BIND"], &["flags", "env_shell", "env_file"], shell, dotenv, flags, None);
    if let Some(value) = declmig_web_bind {
        out.insert("DECLMIG_WEB_BIND".to_string(), value);
    }
